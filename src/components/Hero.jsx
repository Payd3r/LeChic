      ...
      <div className="relative container mx-auto px-6 text-center z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg md:text-xl lg:text-2xl text-white mb-8 max-w-3xl mx-auto font-lato leading-relaxed" style={{ textShadow: '1px 1px 4px rgba(0,0,0,0.7)' }}>
            Le Chic è il centro estetico ad Albavilla specializzato in trattamenti di bellezza, benessere e relax. Scopri come valorizzare la tua bellezza naturale in un ambiente accogliente e professionale.
          </p>
